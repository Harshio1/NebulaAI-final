...
function hue2(a, b) {
  var d = b - a;
  return d ? linear2(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default3(isNaN(a) ? b : a);
}
function gamma2(y) {
...
function nogamma2(a, b) {
  var d = b - a;
  return d ? linear2(a, d) : constant_default3(isNaN(a) ? b : a);
}
...
function zoom_default3() {
  ...
  function dblclicked(event, ...args) {
    ...
    noevent_default2(event);
    if (duration > 0) select_default(this).transition().duration(duration).call(schedule, t13, p0, event);
    else select_default(this).call(zoom.transform, t13, p0, event);
  }
  ...
  zoom.filter = function(_) {
    return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default4(!!_), zoom) : filter;
  };
