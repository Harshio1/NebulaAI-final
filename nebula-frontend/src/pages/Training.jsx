          ...
          {!isTraining ? (
            <div className="flex gap-2">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => handleStartTraining('mnist')}
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-brand/10 text-white font-medium shadow-md border border-brand/20 text-sm"
              >
                <Play className="w-4 h-4 fill-current" /> MNIST
              </motion.button>
              <motion.button 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => handleStartTraining('fashion')}
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-500/10 text-white font-medium shadow-md border border-purple-500/20 text-sm"
              >
                <Play className="w-4 h-4 fill-current" /> Fashion
              </motion.button>
              <motion.button 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => handleStartTraining('cifar')}
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-500/10 text-white font-medium shadow-md border border-blue-500/20 text-sm"
              >
                <Play className="w-4 h-4 fill-current" /> CIFAR-10
              </motion.button>
            </div>
          ) : (
            <motion.button 
