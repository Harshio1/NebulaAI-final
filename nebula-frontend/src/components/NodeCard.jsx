        ...
        <div className="flex items-center gap-3">
          ...
          {!isFailed && (
            <button 
              onClick={async (e) => {
                e.stopPropagation();
                await api.simulateNodeFailure(node.id);
                // The parent will refresh or it will update via WebSocket
              }}
              title="Simulate Failure"
              className="text-gray-500 hover:text-red-500 transition-colors z-20 relative cursor-pointer"
            >
